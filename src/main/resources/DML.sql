insert into UserU(username, firstname, lastname, email, roles, password) values('admin', 'admin', 'adminowski', 'admin@admin.pl', 'ROLE_ADMIN', '098f6bcd4621d373cade4e832627b4f6');
